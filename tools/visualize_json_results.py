...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", default=r"/home/dl/Documents/detectron2_old/output/inference/coco_instances_results.json", required=True, help="JSON file produced by the model")
    parser.add_argument("--output", default=r"/home/dl/Documents/detectron2_old/output/predict_result", required=True, help="output directory")
